module github.com/starter-go/v0/rbac-web-app

go 1.23

require github.com/starter-go/security-gorm v1.0.55
...
require (
	...
	github.com/starter-go/v0/subjects v0.0.2 // indirect
)
