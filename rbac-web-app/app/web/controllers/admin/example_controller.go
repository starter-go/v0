...
func (inst *ExampleController) handleGetQuery(c *gin.Context) {
...
func (inst *innerExampleTask) doFindOneItem() error {
...
func (inst *innerExampleTask) doGetQuery() error {
